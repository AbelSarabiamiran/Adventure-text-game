...
public abstract class AdvCommand {
	...
	/** The predefined entry for the RESTART command */
	public static final AdvCommand RESTART = new RestartCommand();
...
class RestartCommand extends AdvCommand {
	public void execute(Adventure game, AdvObject obj) {
		game.executeRestartCommand();
	}
}